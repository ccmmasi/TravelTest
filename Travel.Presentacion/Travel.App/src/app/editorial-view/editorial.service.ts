...
@Injectable()
export class EditorialViewService {
  ...
  public Editorial_ObtAll() {
    return new Promise((resolve) => {
      this.http.get(this.urlService.Editorial_ObtAll )
        .subscribe(
          (res) => {
  ...
  public Editorial_ObtUno(paramsData) {
    return new Promise((resolve) => {
      this.http.get(this.urlService.Editorial_ObtUno, paramsData )
        .subscribe(
          (res) => {
            resolve(res.toString());
          },
  ...
  public Editorial_Insertar(paramsData) {
    return new Promise((resolve) => {
      this.http.post(this.urlService.Editorial_Insertar, paramsData)
        .subscribe(
          data => {
  ...
  public Editorial_Actualizar(paramsData) {
    return new Promise((resolve) => {
      this.http.post(this.urlService.Editorial_Actualizar, paramsData )
        .subscribe(
          data => {
          console.log("POST Request is successful ", data);
          },
