...
@Injectable()
export class AutorLibroViewService {
  ...
  public AutorLibro_ObtAll() {
    return new Promise((resolve) => {
      this.http.get(this.urlService.AutorLibro_ObtAll )
        .subscribe(
          (res) => {
  ...
  public AutorLibro_ObtUno(paramsData) {
    return new Promise((resolve) => {
      this.http.get(this.urlService.AutorLibro_ObtUno, paramsData )
        .subscribe(
          (res) => {
            resolve(res.toString());
          },
  ...
  public AutorLibro_Insertar(paramsData) {
    return new Promise((resolve) => {
      this.http.post(this.urlService.AutorLibro_Insertar, paramsData)
        .subscribe(
          data => {
  ...
  public AutorLibro_Actualizar(paramsData) {
    return new Promise((resolve) => {
      this.http.post(this.urlService.AutorLibro_Actualizar, paramsData )
        .subscribe(
          data => {
          console.log("POST Request is successful ", data);
          },
