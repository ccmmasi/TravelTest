...
export class LibroViewService {
  ...
  public Libro_ObtAll() {
    return new Promise((resolve) => {
      this.http.get(this.urlService.Libro_ObtAll )
        .subscribe(
          (res) => {
  ...
  public Libro_ObtUno(paramsData) {
    return new Promise((resolve) => {
      this.http.get(this.urlService.Libro_ObtUno, paramsData )
        .subscribe(
          (res) => {
            resolve(res.toString());
          },
  ...
  public Libro_Insertar(paramsData) {
    return new Promise((resolve) => {
      this.http.post(this.urlService.Libro_Insertar, paramsData)
        .subscribe(
          data => {
  ...
  public Libro_Actualizar(paramsData) {
    return new Promise((resolve) => {
      this.http.post(this.urlService.Libro_Actualizar, paramsData )
        .subscribe(
          data => {
          console.log("POST Request is successful ", data);
          },
